            ...
            <CardContent>
              <div className="bg-indigo-50 p-5 rounded-lg mb-6">
                <p className="text-neutral-700">
                  Based on your chakra assessment, you would benefit from focusing on creating greater balance between your energy centers. 
                  {coachingRecommendations.focusChakra.description} Regular practice of the recommended exercises, 
                  combined with self-reflection, will help you create greater harmony in your energy system over time.
                </p>
              </div>
              <div className="flex justify-between">
                ...
                <Button 
                  ...
                  onClick={() => {
                    const coachType = coachingRecommendations.recommendedCoach === "inner_child" ? "inner-child" :
                      coachingRecommendations.recommendedCoach === "shadow_self" ? "shadow" :
                      coachingRecommendations.recommendedCoach === "higher_self" ? "higher-self" : "integration";
                    setLocation(`/coach/${coachType}`);
                  }}
                >
