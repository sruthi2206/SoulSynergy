...
${status.level === 'balanced' 
  ? `Balanced Traits: ${chakra.balancedTraits.join(', ')}`
  : status.level === 'underactive'
    ? `Underactive Signs: ${chakra.underactiveTraits.join(', ')}`
    : `Overactive Signs: ${chakra.overactiveTraits.join(', ')}`
}
                        ...
                        <div className="text-sm space-y-2 mb-3">
                          {status.level === "balanced" ? (
                            ...
                            <div>
                              ...
                              <ul className="list-disc pl-5 space-y-1">
                                {chakra.underactiveTraits.slice(0, 3).map((trait, idx) => (
                                  <li key={idx}>{trait}</li>
                                ))}
                              </ul>
                            </div>
                            ...
                            <div>
                              ...
                              <ul className="list-disc pl-5 space-y-1">
                                {chakra.overactiveTraits.slice(0, 3).map((trait, idx) => (
                                  <li key={idx}>{trait}</li>
                                ))}
                              </ul>
                            </div>
